...
import type { BulletedListElement, OrderedListElement } from "../custom-types"
  ...
  editor.insertText = (text) => {
    ...
    if (text.endsWith(" ") && selection && Range.isCollapsed(selection)) {
      ...
      if (type) {
        ...
        if (type === "list-item") {
          const list: BulletedListElement | OrderedListElement = {
            type: beforeText === "1." ? "ordered-list" : "bulleted-list",
            children: [],
          }

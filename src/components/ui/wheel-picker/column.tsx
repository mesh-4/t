import { CSSProperties, HTMLProps, useCallback, useEffect, useMemo, useRef, useState } from "react"

import { usePickerActions, usePickerData, PickerColumnDataContext } from "./context"
...
function PickerColumn({ style, children, name: key, ...restProps }: PickerColumnProps) {
  ...
  const minTranslate = useMemo(() => {
    return height / 2 - itemHeight * options.length + itemHeight / 2
